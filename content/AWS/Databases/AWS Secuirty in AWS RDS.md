---
date created: 2025-06-21T01:24:18+04:00
date modified: 2025-06-21T01:53:06+04:00
---
# [[Encryption and Encoding]]
Encryption in transit: accomplished with SSL/TLS connection between client and RDS instance, can be mandatory.

Encryption at rest: [[AWS RDS]] supports EBS [[AWS KMS]] encryption[^1], with either AWS managed keys or Customer managed keys. Data key (DEK) is used for encryption operations.
...
MSSQL and Oracle support TDE[^2], in addition latter supports TDE with [[AWS Cloud-HSM]] meaning no key exposure to AWS.
