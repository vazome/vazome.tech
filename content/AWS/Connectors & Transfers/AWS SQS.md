...
date modified: 2025-06-21T01:52:39+04:00
---
Related: [[IT Software Architectures#Queues]]
...
**Visibility timeout** can make message to reappear if message was not deleted by the client when the job is done – help in [[Resilience and Reliability#Fault Tolerance (FT)]] implementation. [Amazon SQS visibility timeout - Amazon Simple Queue Service](https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html)
...
Complicated example with use of [[AWS SNS]] Topics to SQS Queues (Fanout) 
