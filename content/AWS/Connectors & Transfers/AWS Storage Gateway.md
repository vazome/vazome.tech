...
Uses iSCASI, NFS and SMB

On AWS Side: [[AWS EBS]], [[AWS S3 Simple Storage Service]] and S3 + Glacier
...
## Cached mode
Now primary location of data is in [[AWS S3 Simple Storage Service]]. The only local thing is cache.
...
Exported tape means it's moved to Glacier for Archival. Can be used if you have expensive back up system, and you want to replace want to offload expensive parts to AWS. Or as back up extension or help in migration of tapes to AWS.
