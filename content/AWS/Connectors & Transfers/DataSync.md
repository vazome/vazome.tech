Managed data transfer process TO and FROM AWS end-to-end (vice-versa). Reliable transfer of large quantities of data and integrates with [[EFS]], [[S3 Simple Storage Service]]... 
