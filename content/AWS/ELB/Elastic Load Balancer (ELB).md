...
- Internet facing – public + private IP addresses
	- But [[AWS/EC2/EC2]] instances that are used, do not have to be public
...
| Feature                       | ELB type |
| ----------------------------- | -------- |
| Unbroken encryption           | [[Elastic Load Balancer (ELB)#NLB]]      |
| Static IP for white listening | [[Elastic Load Balancer (ELB)#NLB]]      |
| The fastest performance       | [[Elastic Load Balancer (ELB)#NLB]]      |
| Not HTTP and HTTPS            | [[Elastic Load Balancer (ELB)#NLB]]      |
| [[Privatelink]]               | [[Elastic Load Balancer (ELB)#NLB]]      |
