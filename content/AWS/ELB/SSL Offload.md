Related: [[Elastic Load Balancer (ELB)]]

# Options
![[Screenshot 2023-02-01 at 02.28.16.png]]
## Bridging mode
Default for [[Elastic Load Balancer (ELB)#ALB]].
...
## Pass-through 
Default for [[Elastic Load Balancer (ELB)#NLB]].
...
There are applications made with state-less approach for example, using [[DynamoDB]] to store sessions. ==Better to have state-less approach== But there are many cases when this is not applicable.
