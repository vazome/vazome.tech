...
NOT Real Time.
Export to [[S3 Simple Storage Service]] (view them directly and easy export to 3rd party) or [[CloudWatch Logs]] (view them in AWS UI and connect it to other AWS Services)
