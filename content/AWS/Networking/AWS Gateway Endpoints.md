...
date modified: 2025-06-21T01:58:18+04:00
---
Related: [[VPC]], [[VPC Routing]]

HA on all subnets (regionally available), not cross-regional

Provides private network access to [[AWS S3 Simple Storage Service]] and [[AWS DynamoDB]], without public IP addressing. Per service per region, associated with one or more subnets.
